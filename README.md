...
Unsupervised Learning: Applying K-Means Clustering for household segmentation

Dimensionality Reduction: Using Principal Component Analysis (PCA) for 2D cluster visualization

Interactive Visualization: Building a Dash web application for real-time exploration of clustering results
...
Clustering with Two Features — Compared inertia and silhouette metrics to select the optimal cluster count.

Clustering with Multiple Features — Built a Pipeline combining StandardScaler + KMeans.

Dimensionality Reduction (PCA) — Visualized clusters in 2D.

Interactive Dash App — Created an interactive dashboard for cluster exploration.
...
Developed a PCA-based visualization that clearly separated business owners.
